 ...
 *
 * 
 * The class <code>BMCEPBusInboundPort</code> implements the inbound port for
 * the {@code CEPBusManagementCI} interface. It's the port of CEPBus
 * 
 * <p>
 ...
 *         </p>
 */
public class BMCEPBusInboundPort 
extends AbstractInboundPort 
implements CEPBusManagementCI 
{
	private static final long serialVersionUID = 1L;

	public BMCEPBusInboundPort(ComponentI owner)
			throws Exception {
		super(CEPBusManagementCI.class, owner);
		assert owner instanceof CEPBus;
	}

	public BMCEPBusInboundPort(String uri, ComponentI owner)
			throws Exception { 
